...
public class SliceInfo {
    ...
    private final long getNumberOfElements; //현재 슬라이스가 가지고 있는 엔티티 개수

    private final boolean hasNext; //다음 슬라이스 존재 유무

    private final boolean hasPrevious; //이전 슬라이스 존재 유무
